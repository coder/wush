import Terminal from "@/components/Access";
import Receive, { type IncomingFile } from "@/components/Receive";
...
type TabType = "send" | "receive" | "access" | "rtc";
...
//               {activeTab === "receive" && <Receive wush={wush} />}
//               {activeTab === "access" && <Terminal wush={wush} />}
//             </div>
//           </div>
//         </div>
//       </main>
